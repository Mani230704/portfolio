...
const About = () => {
  ...
  const imageKitUrl = "https://ik.imagekit.io/manik/Screenshot%202025-04-04%20163556.png?updatedAt=1743764840684";
  const profileImagePath = "/Screenshot%202025-04-04%20163556.png?updatedAt=1743764840684"; // Path to your image on ImageKit
