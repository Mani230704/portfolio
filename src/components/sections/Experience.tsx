...
const experiences = [
  ...
  {
    title: 'Convener of Brain and Mind Strategic Games Club',
    ...
    logo: 'https://ik.imagekit.io/manik/download.jfif?updatedAt=17437644378412'
  },
];
...
const educationItems = [
  {
    ...
    company: 'SRM University, AP',
    period: '2022 - 2026',
    description: 'Maintaining a 7.07 CGPA while actively participating in various technical clubs and events. Specializing in computer science with a focus on modern technologies.',
    skills: ['Computer Science', 'Data Structures', 'Algorithms', 'Machine Learning'],
    logo: 'https://ik.imagekit.io/manik/download.jfif?updatedAt=1743764437841'
  },
  {
    title: 'Higher Secondary Certificate (Intermediate)',
    company: 'Bhashyam Junior College of Education',
    period: '2020 - 2022',
    description: 'Completed higher secondary education with 77% marks, focusing on Mathematics, Physics, and Chemistry.',
    skills: ['Mathematics', 'Physics', 'Chemistry'],
    logo: 'https://ik.imagekit.io/manik/images.png?updatedAt=1742292609003'
  },
  {
    title: 'Secondary School Certificate',
    company: 'Bhashyam school',
    period: '2019 - 2020',
    description: 'Completed SSC board examination with 100% marks.',
