      ...
      <div className="container mx-auto">
        <div className="flex items-center justify-between">
          ...
          >
            ...
            <span className="text-primary">Mani Kommineni</span>
            <span className="font-mono">{'/>'}</span>
          </a>
          ...
          <div className="hidden md:block">
            <a
              href="https://drive.google.com/file/d/1HW1KUOOtCoah-VHNP_V2FiBJdV6oz7kQ/view?usp=sharing" // Add link to your resume
              target="_blank"
